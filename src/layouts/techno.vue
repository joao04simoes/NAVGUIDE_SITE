  ...
  <section class="bg-cyan-700 py-10 px-6 text-white">
    <div class="container mx-auto text-center ">
      ...
      <p class="text-lg max-w-5xl mx-auto">
        The NavGuide system is a cutting-edge navigation solution designed to provide visually impaired individuals with
        precise, real-time guidance in supermarkets. Combining UWB localization, a database, and a mobile app,
        it offers accurate positioning, dynamic route planning, and auditory assistance, enhancing accessibility,
        independence, and convenience for users.</p>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div class="bg-white shadow-xl rounded-xl p-6 transition hover:shadow-2xl transform duration-300">
          ...
          <div class="space-y-2 text-center text-gray-700">
            ...
            <p>Draws routes to each product in real-time and recalculates the route if the user deviates from the
              planned path.</p>
